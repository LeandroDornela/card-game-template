...
{
    public class BehaviourDamageHealth : CardBehaviour
    {
        ...
        public override bool TryActivateBehaviour(PlayerState owner, List<IBehaviourTargetWrapper> possibleTargetsToApply)
        {
            ...
            foreach(IBehaviourTargetWrapper targetWrapper in possibleTargetsToApply)
            {
                ...
                if(playerState == null)
                {
                    ...
                    Debug.LogWarning(Debug.Category.GameLogic, $"Received a target unusable by {GetType()}.");
                    continue;
                }

                if(playerState.Health == null)
                {
                    Debug.LogError(Debug.Category.GameLogic, "Health Component is invalid.");
                    return false;
                }
